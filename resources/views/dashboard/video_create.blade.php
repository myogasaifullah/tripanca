...
<div class="container">
    ...
    <form action="{{ route('videos.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="url" name="url" value="{{ old('url') }}" required placeholder="https://www.youtube.com/watch?v=VIDEO_ID or https://youtu.be/VIDEO_ID">
        </div>
        <div class="mb-3">
