    ...
    <div class="d-flex">
        ...
        <nav class="sidebar p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('profile.edit')); ?>"><i class="fas fa-user me-2"></i>Profile</a>
                </li>
                <li class="nav-item">
        ...
        <div class="content flex-grow-1">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Dashboard</h1>
                <div>
                    <span class="text-muted">Welcome, <?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
                </div>
            </div>
                    ...
                    <div class="card text-white bg-primary">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h5 class="card-title"><?php echo e(\App\Models\User::count()); ?></h5>
...
<?php /**PATH C:\laragon\www\laravel\tripanca\resources\views/dashboard.blade.php ENDPATH**/ ?>