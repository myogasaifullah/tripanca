...
<div class="container-fluid product py-5">
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="<?php echo e(0.2 + ($index * 0.2)); ?>s">
                <div class="product-item">
                    <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : '/build/assets/img/water.png'); ?>" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p><?php echo e($product->size); ?></p>
                        <a href="#" class="h4 d-inline-block mb-3"><?php echo e($product->name); ?></a>
                        <p class="fs-4 text-primary mb-3">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
    ...
    <div class="container pb-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="<?php echo e(0.2 + ($index * 0.2)); ?>s">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<?php echo e($blog->image ? asset('storage/' . $blog->image) : '/build/assets/img/blog-1.jpg'); ?>" class="img-fluid rounded-top w-100" alt="<?php echo e($blog->title); ?>">
                        <div class="blog-date px-4 py-2"><i class="fa fa-calendar-alt me-1"></i> <?php echo e(\Carbon\Carbon::parse($blog->published_at)->format('d M Y')); ?></div>
                    </div>
                    <div class="blog-content rounded-bottom p-4">
                        <a href="#" class="h4 d-inline-block mb-3"><?php echo e($blog->title); ?></a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel\tripanca\resources\views/landing/welcome.blade.php ENDPATH**/ ?>